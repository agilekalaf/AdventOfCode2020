...
def add_values(i,a,b):
  sum = entries2[a] + entries2[i] + entries2[b]
  return sum
...
for num in entries2:
    ...
    if(b >= len(entries2)):
      ...
      i += 1
      b = 2
      #print(add_values(i,a,b))
    else:
      if add_values(i,a,b) == 15:
        print(add_values(i,a,b))
        print(entries2[i], entries2[b], entries2[a], "*")
        break
      else:
        print(add_values(i,a,b), entries2[a], entries2[i], entries2[b], "!")    
'''

for num in entries2:
  i += 1
  if(i >= len(entries2)):
    print("end of list for i")
    break
  else:
    b += 1
    if(b >= len(entries2)):
      print("end of list for b")
      b = 3
    else:
      if add_values(i,a,b) == 15:
        print(add_values(i,a,b))
        print(entries2[a], entries2[i], entries2[b], "*")
        break
      else:
        print(add_values(i,a,b), entries2[a], entries2[i], entries2[b], "!")
